...
//
//  หนี้เลือดของ "กลับไปแก้ไข" ตั้งใจให้ทบได้ (ดู collectDebt) — ย้อน 2 ครั้งในเทิร์นเดียว
//  = หนี้ 8 หน่วย ซึ่งเกินความจุสูงสุด แปลว่าตายแน่นอนตอนขึ้นเทิร์นถัดไป นั่นคือความเสี่ยงที่ผู้เล่นเลือกเอง
...
// ---------- ท่าไม้ตาย ----------
const REWIND_HP_COST = 4;        // กลับไปแก้ไข: หนี้เลือดที่จะถูกเก็บตอนขึ้นเทิร์นถัดไป
