...
//  อย่าทำอะไรไม่เข้าท่าเลย (สกิลพื้นฐาน) / อืม ฉันเข้าใจแล้ว (สกิลรอง) / ทุกอย่างจะต้องราบรื่น (ท่าไม้ตาย)
...
//    - godslay / shikiCancelUltimate / SHIKI_CANCELABLE_ULTS: สกิลพื้นฐาน "อย่าทำอะไรไม่เข้าท่าเลย"
...
module.exports = {
  ...
  // เรียกจาก afterSummary()/doAttack() — โจมตีปกติไม่ได้เลย เว้นแต่กำลังติด "ชักดาบ" อยู่
  cannotAttack(p) {
  ...
  // ---------- สกิลพื้นฐาน อย่าทำอะไรไม่เข้าท่าเลย ----------
