...
module.exports = {
  ...
  // ---------- หลบหลีก ----------
  //  โรลหลบ 1 ครั้งต่อเทิร์น — ใช้ได้ทั้งกับการโจมตีปกติ (doAttack) และดาเมจจากสกิล (adjustIncomingDamage)
  //  คืน true = หลบพ้น
  tryDodge(engine, p, what) {
    ...
    p.eijiDodgeUsedRound = true; // โควตาหมดไม่ว่าจะหลบพ้นหรือไม่
